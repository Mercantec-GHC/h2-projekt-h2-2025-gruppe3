...
//                {
//                    Name = hotelName,
//                    Road = baseFaker.PickRandom(danishStreets) + " " + baseFaker.Random.Int(1, 200) + ", " + baseFaker.Random.Int(1000, 9999),
//                    Zip = baseFaker.Random.Int(1000, 9999) + " " + baseFaker.PickRandom(danishCities) + ", Danmark",
//                    City = baseFaker.PickRandom(danishCities) + ", Danmark",
