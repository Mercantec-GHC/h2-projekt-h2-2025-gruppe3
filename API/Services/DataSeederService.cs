...
namespace API.Services
{
    ...
    public class DataSeederService
    {
        ...
        ///// </summary>
        //private async Task<List<Booking>> SeedBookingsAsync(List<User> users, List<Room> rooms, List<Roomtype> roomtypes, int count)
        //{
        //    var bookings = new List<Booking>();
        //    var bookingStatuses = new[] { BookingStatus.Confirmed, BookingStatus.Cancelled, BookingStatus.CheckedIn, BookingStatus.CheckedOut };
        ...
        //                FinalPrice = roomtype.PricePerNight * nights,
        ...
        //        var existingRoomtypes = await _context.Rooms.Include(r => r.Bookings).ToListAsync();
        ...
        //        summary.AppendLine($"Fundet {existingUsers.Count} brugere og {existingRooms.Count} rum og {existingRooms.Count} rum");
